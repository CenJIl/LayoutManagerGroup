...
public class BannerActivity extends AppCompatActivity {
    ...
    private void initView() {
        ImageView mLastImg, mCurrentImg;
        ...
        bannerLayoutManager.setOnSelectedViewListener((view, position) -> changeUI(position));
        changeUI(0);

        /*消息轮播*/
        RecyclerView mRecycler_2 = findViewById(R.id.recycler2);
